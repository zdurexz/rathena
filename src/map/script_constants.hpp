...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(IG_17CARAT_BOX1);
	export_constant(IG_17CARAT_BOX2);
	export_constant(IG_17CARAT_BOX3);
	export_constant(IG_17CARAT_BOX4);
	export_constant(IG_17CARAT_BOX5);
	export_constant(IG_17CARAT_BOX6);
	export_constant(IG_17CARAT_BOX7);
	export_constant(IG_17CARAT_BOX8);
	export_constant(IG_17CARAT_BOX9);
	export_constant(IG_17CARAT_BOX10);
	export_constant(IG_17CARAT_BOX11);
	export_constant(IG_17CARAT_BOX12);
	export_constant(IG_17CARAT_BOX13);
	export_constant(IG_17CARAT_BOX14);
	export_constant(IG_17CARAT_BOX15);
